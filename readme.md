...
* [1. VPC 생성](https://github.com/gnosia93/vlm-on-eks/blob/main/ec2/1-vpc-create.md)
* [2. 데이터셋 준비하기](https://github.com/gnosia93/vlm-on-eks/blob/main/ec2/2-preparing-datasets.md)
* [3. 과제 정의 + 프레임 예산 결정   (프롬프트 설계의 앞부분)]
* [4. 영상 샘플링]
* [5. 프롬프트 구체화/튜닝           (프레임 보면서)]
* [6. InternVL3-78B 모델 vLLM 인퍼런스](https://github.com/gnosia93/vlm-on-eks/blob/main/ec2/3-ec2-vlm-infer.md)
* 
