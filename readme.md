...
* [6. Student 모델 zero-shot 영상 이해도 측정 -> FUll / LoRA 선택기준](https://github.com/gnosia93/vlm-distillation/blob/main/ec2/6-student-level-test.md)
...
* [InternVL3-78B 기반 학습 데이터 생성 (K8s Job)](https://github.com/gnosia93/vlm-on-eks/blob/main/labs/5-vlm-infer.md) — 다수의 Job으로 VLM 배치 인퍼런스를 병렬 수행해 Student 모델 학습용 데이터를 생성.
* Student 모델 병렬 학습 — 확보한 학습 데이터로 1B급 경량 모델을 학습.
