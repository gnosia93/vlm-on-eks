...
* [InternVL3-78B 기반 학습 데이터 생성 (K8s Job)](https://github.com/gnosia93/vlm-on-eks/blob/main/labs/5-vlm-infer.md) — 다수의 Job으로 VLM 배치 인퍼런스를 병렬 수행해 Student의 학습용 데이터를 생성.
* Student 모델 학습 (DDP)
